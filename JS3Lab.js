 ...
 * Step 1: Convert the alphabetString to an array and print it to the console 
 * (See documentation: https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/String/split)
 * 
 * 
 * ↓ YOUR CODE HERE ↓ */
...
/*
 * Using the provided code above:
 * Step 1: Reorganize the alphabet array from z to a 
 * (See documentation: https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Array/reverse)
 * Step 2: Convert the elements of the array into a string 
 * (with no spaces between the letters) and print it to the console 
 * (See documentation: https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Array/join)
 * 
 * 
 * ↓ YOUR CODE HERE ↓ */
 ...
 * Step 6: Print the last element again. 
 * Did it change from earlier? Are you able to get the last element that was just added?
 * 
 * 
 * ↓ YOUR CODE HERE ↓ */
...
/*
 * Using the provided code above, you will do multiple tasks. 
Print results to the console after every change to the array(s).
 * Step 1: Create a variable called myTodoList that holds an empty array 
 * Step 2: Add three todo items (elements) to the array using a built-in 
 * array method, then print myTodoList to the console 
 * (See documentation: https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Array/push)
 * Step 3: Remove the second element in the array, print the array to the console
 * Step 4: Create another array called yourTodoList, add two todo items, 
 * and print the array to the console
 * Step 5: Create another array called ourTodoList, 
 * then concatenate (combine) myTodoList and yourTodoList into 
 * the array ourTodoList, there's more than one way to do this.
 * (See documentation: https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Array/concat  OR  https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Operators/Spread_syntax)
 * 
 * 
 * ↓ YOUR CODE HERE ↓ */
var myTodoList = []

myTodoList.push('Grocery shopping','Wash car', 'Do homework' )
console.log("Step 1 & 2: ", myTodoList)

myTodoList.splice(1,1)
console.log("Step 3: ", myTodoList)

var yourTodoList = ['Walk dogs', 'Feed cats']
 ...
 * Step 1:  Create a function called "isEven"(See documentation: )
        ...
        * (See documentation: https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Operators/Remainder)
 ...
 * Hint: use a for loop to iterate through the array and add each element 
 * to a variable that holds the sum of all the numbers 
 ...
 * Step 1: Create a function called "reverse" (See documentation: )
        ...
        * If it's an array, return the reversed array with each element
        *  reversed (i.e. ['hello', 'world'] becomes ['dlrow', 'olleh'])
...
/*
 * Step 1:  Create a function called whichArrayIsLonger. 
The purpose of this function is to determine which array has the most elements
